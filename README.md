...
% sh deploy_mac.sh
% ~/bin/butler login
% ~/bin/butler push target/release/bundle/dmg/tetorica-mdrop_0.4.5_aarch64.dmg kyorohiro/tetorica-mdrop:mac-apple-silicon --userversion 0.4.5

% ~/bin/butler push target/x86_64-apple-darwin/release/bundle/dmg/tetorica-mdrop_0.4.5_x64.dmg kyorohiro/tetorica-mdrop:mac-intel --userversion 0.4.5

% ~/bin/butler push "tetorica-mdrop_0.4.5_x64-setup.exe" kyorohiro/tetorica-mdrop:windows --userversion 0.4.5

% ~/bin/butler push "tetorica-mdrop_0.4.5_amd64.AppImage" kyorohiro/tetorica-mdrop:linux-appimage-amd64 --userversion 0.4.5
% ~/bin/butler push "tetorica-mdrop_0.4.5_amd64.deb" kyorohiro/tetorica-mdrop:linux-deb-amd64 --userversion 0.4.5
% ~/bin/butler push "tetorica-mdrop-0.4.5-1.x86_64.rpm" kyorohiro/tetorica-mdrop:linux-rpm-amd64 --userversion 0.4.5
