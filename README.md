...
% sh deploy_mac.sh
% ~/bin/butler login
% ~/bin/butler push src-tauri/target/release/bundle/dmg/tetorica-mdrop_0.3.2_aarch64.dmg kyorohiro/tetorica-mdrop:mac-apple-silicon --userversion 0.3.2

% ~/bin/butler push src-tauri/target/x86_64-apple-darwin/release/bundle/dmg/tetorica-mdrop_0.3.2_x64.dmg kyorohiro/tetorica-mdrop:mac-intel --userversion 0.3.2

% ~/bin/butler push "tetorica-mdrop_0.3.2_x64-setup.exe" kyorohiro/tetorica-mdrop:windows --userversion 0.3.2
```
