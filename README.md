...
% sh deploy_mac.sh
% ~/bin/butler login
% ~/bin/butler push target/release/bundle/dmg/tetorica-mdrop_0.3.5_aarch64.dmg kyorohiro/tetorica-mdrop:mac-apple-silicon --userversion 0.3.5

% ~/bin/butler push target/x86_64-apple-darwin/release/bundle/dmg/tetorica-mdrop_0.3.5_x64.dmg kyorohiro/tetorica-mdrop:mac-intel --userversion 0.3.5
